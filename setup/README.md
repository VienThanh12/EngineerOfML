...
#### Option 2 (Encouraged for MacOS users with Apple Chips M1/M2/M3)
Incase you have challenges with your MacOS + VirtualBox + Image setup, you can create a remote client that will serve as your local machine. Follow the instructions [here](./docs/local_env_in_cpouta.md)

#### Option 3 (We do not provide technical support for these options)
